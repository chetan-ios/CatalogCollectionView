...
public class CatalogDataSource: UIView{
    ...
    public func registerCellCollectionView(){
        catalogCollectionView?.register(UINib(nibName:"CatalogCollectionViewCell",bundle:Bundle(identifier: "com.arvind.omuniimagescroller.CatalogImage")), forCellWithReuseIdentifier: "catalogCell")
    }
